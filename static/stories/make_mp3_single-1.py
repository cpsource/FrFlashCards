...
Examples:
  python make_mp3_single.py greeting "use a woman's voice" "Bonjour tout le monde."
  python make_mp3_single.py warning "speak slowly and clearly" "Attention à la marche."
...
def main():
    ...
    # Combine instructions and main text for the model to interpret naturally
    full_text = f"{instructions.strip()} {text.strip()}"
    ...
    try:
        result_file = tts_to_mp3(full_text, out_base)
