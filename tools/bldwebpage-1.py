...
Usage: python bldwebpage.py <image.png> <audio.mp3> <text> <test_number>
"""

import sys
import os

def generate_html(image_path, audio_path, text, test_number):
...
<body>
    <div class="container">
        ...
        <div id="nextButtonContainer" class="next-button-container">
            <a href="tst-{test_number + 1}.html" class="btn btn-success btn-lg">Image Suivante</a>
        </div>
...
def main():
    if len(sys.argv) != 5:
        print("Usage: python bldwebpage.py <image.png> <audio.mp3> <text> <test_number>")
        print("Exemple: python bldwebpage.py photo.png reponse.mp3 'La Tour Eiffel' 1")
        sys.exit(1)
    ...
    html_content = generate_html(image_path, audio_path, text, test_number)
